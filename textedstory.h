...
public:
    ...
    static inline QStringList prologText=QStringList({"Однажды Polly по травке на поле гуляла",
                                                      ...
                                                      "Знакомтесь! Это Lolly - друг очень хороший который есть у нашей Polly"});
